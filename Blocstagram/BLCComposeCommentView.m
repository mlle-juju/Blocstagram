...
- (NSAttributedString *) commentAttributedString {
    ...
    UIFont *helveticaFont = [UIFont fontWithName:@"HelveticaNeue-Bold" size:10];
    
    [commentString addAttribute:NSFontAttributeName value:helveticaFont range:range];
