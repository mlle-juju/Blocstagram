...
/**
 The CAShapeLayer for the circle around the heart
 */
...
#pragma mark - Building the Animation
...
- (CAShapeLayer *)circleLayer {
    if (!_circleLayer) {
        ...
        _circleLayer.lineWidth = self.strokeThickness; //Question here. self.strokeThickness ???
...
#pragma mark - Correctly Position the Circle Layer
//Position the circle layer in the center of the view
